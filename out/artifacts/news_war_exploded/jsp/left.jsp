	...
	<c:choose>
		<c:when test="${sessionScope.login_user.roleId==1}">
			<dl class="leftmenu">
				<dd>
					<div class="title">
						<span><img src="../images/leftico04.png"  alt=""/></span>用户管理
					</div>
					<ul class="menuson">
						<li><cite style="margin-left: -4px;"></cite><a href="${pageContext.request.contextPath}/findUserList.action" target="rightFrame">用户列表</a><i></i></li>
						<li><cite></cite><a href="${pageContext.request.contextPath}/toAddUser.action" target="rightFrame">添加用户</a><i></i></li>
					</ul>
				</dd>
				<dd>
					<div class="title">
						<span><img src="../images/leftico02.png"  alt=""/></span>新闻类别管理
					</div>
					<ul class="menuson">
